...
public class LoginAndLoginResultView extends Composite implements ISubscriber {
	...
	public LoginAndLoginResultView() {
		...
		//panel.setWidgetLeftWidth(CreateAcctBtnPanel, 103.0, Unit.PX, 150.0, Unit.PX);
		CreateAcctBtnPanel.setSize("150px", "40px");
		//panel.setWidgetLeftWidth(CreateAcctBtnPanel, 76.0, Unit.PX, 141.0, Unit.PX);
		panel.setWidgetTopHeight(CreateAcctBtnPanel, 372.0, Unit.PX, 43.0, Unit.PX);
		...
		loginButtonPanel.setSize("150px", "40px");
		//panel.setWidgetLeftWidth(loginButtonPanel, 76.0, Unit.PX, 143.0, Unit.PX);
